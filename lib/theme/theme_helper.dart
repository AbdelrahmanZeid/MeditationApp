...
class ColorSchemes {
  static final primaryColorScheme = ColorScheme.light(
    ...
    secondary: Color(0XFF1F265E),
    secondaryContainer: Color(0XFFFF7C6B),
    tertiary: Color(0XFF1F265E),
    tertiaryContainer: Color(0XFFFF7C6B),

    // Background colors
    background: Color(0XFF1F265E),

    // Surface colors
    surface: Color(0XFF1F265E),
    surfaceTint: Color(0XFF03174C),
    surfaceVariant: Color(0XFFFF7C6B),

    // Error colors
    error: Color(0XFF03174C),
    ...
    onInverseSurface: Color(0XFF7F89FF),
    onPrimary: Color(0XFF03174C),
    onPrimaryContainer: Color(0XFFE0E1E5),
    onSecondary: Color(0XFFE0E1E5),
    onSecondaryContainer: Color(0XFF03174C),
    onTertiary: Color(0XFFE0E1E5),
    onTertiaryContainer: Color(0XFF03174C),

    // Other colors
    outline: Color(0XFF03174C),
    outlineVariant: Color(0XFF1F265E),
    scrim: Color(0XFF1F265E),
    shadow: Color(0XFF03174C),

    // Inverse colors
    inversePrimary: Color(0XFF1F265E),
    inverseSurface: Color(0XFF03174C),

    // Pending colors
    onSurface: Color(0XFFE0E1E5),
    onSurfaceVariant: Color(0XFF03174C),
  );
}
